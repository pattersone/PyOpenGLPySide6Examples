...
class GLWidget(QOpenGLWidget):
    ...
    def __init__(self, parent=None):
        ...
        # A Super 35mm cinema camera is usually about 24.89mm wide: https://en.wikipedia.org/wiki/Super_35
        sensor_width = 24.89
        lens_focal_length = 18 #mm (Say we have 3 primes of 18mm, 28mm, and 58mm). 

        # Calculate field of view in radians from lens focal length, assuming Super 35 format.
        fov_horizontal = 2 * np.arctan(sensor_width / (2 * lens_focal_length))
        self.fov = fov_horizontal

        self.vertex_count = 0
        self.model_yaw = 90.0 # degrees
    ...
    def initializeGL(self):
        ...
        R = self.rotate_y_deg(identity_mat4, self.model_yaw)
    ...
    # Update MVP parameters as desired and trigger new draw call.
